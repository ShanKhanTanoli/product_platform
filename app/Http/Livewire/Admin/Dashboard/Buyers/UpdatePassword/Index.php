...
namespace App\Http\Livewire\Admin\Dashboard\Buyers\UpdatePassword;
...
class Index extends Component
{
    ...
    {
        return view('livewire.admin.dashboard.buyers.update-password.index')
    ...
    public function Update()
    {
        ...
        try {
            ...
            return redirect(route('AdminUpdateBuyerPassword', ['slug' => $this->user->slug, 'lang' => App::getLocale()]));
        } catch (Exception $e) {
