...
namespace App\Http\Livewire\Buyer\Dashboard\Settings\Profile;
...
class Index extends Component
{
    ...
    {
        return view('livewire.buyer.dashboard.settings.profile.index')
    ...
    public function UpdateProfile()
    {
        ...
        try {
            ...
            return redirect(route('BuyerEditProfile', App::getLocale()));
        } catch (Exception $e) {
