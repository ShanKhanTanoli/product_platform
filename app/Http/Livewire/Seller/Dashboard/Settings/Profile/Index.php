...
namespace App\Http\Livewire\Seller\Dashboard\Settings\Profile;
...
class Index extends Component
{
    ...
    {
        return view('livewire.seller.dashboard.settings.profile.index')
    ...
    public function UpdateProfile()
    {
        ...
        try {
            ...
            return redirect(route('SellerEditProfile', App::getLocale()));
        } catch (Exception $e) {
