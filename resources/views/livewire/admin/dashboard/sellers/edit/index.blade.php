<div class="container-fluid my-3 py-3">
    <div class="row mb-5">
        <!--Begin::Sidebar-->
        @include(
            'livewire.admin.dashboard.guests.partials.tab-menu'
        )
        <!--Begin::Sidebar-->
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">
                                    {{ trans('admin.update-guest-profile') }}
                                </h6>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <form wire:submit.prevent='Update'>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-static my-3">
                                                <label for="user_name">{{ trans('admin.guest-username') }}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group input-group-static my-3">
                                                <label for="number">{{ trans('admin.guest-number') }}</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-static my-3">
                                                <label for="email">{{ trans('admin.guest-email') }}</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static my-3">
                                                <label for="role">Guest Role</label>
