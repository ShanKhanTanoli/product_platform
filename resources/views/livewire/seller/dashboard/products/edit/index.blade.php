<div class="container-fluid my-3 py-3">
    <div class="row mb-5">
        <!--Begin::Sidebar-->
        @include('livewire.seller.dashboard.products.edit.partials.tab-menu')
        <!--Begin::Sidebar-->
                                ...
                                <form wire:submit.prevent='Update'>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static my-3">
                                                <label
                                                    for="description">{{ trans('seller.product-description') }}</label>
                                        ...
                                        @if (Category::count() > 0)
                                            <div class="col-md-12">
                                                <div class="input-group input-group-static my-3">
                                                    <label
                                                        for="category_id">{{ trans('seller.product-category') }}</label>
